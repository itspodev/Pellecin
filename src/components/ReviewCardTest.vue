  ...
  data: () => {
    return {
      reviews: [
        ...
        {
          textPt1:
            "Noémie nous a accompagnés dans le cadre de ces études dans la création de contenu de qualité. Elle nous a aussi rafraichis notre logo pour un look moderne et pro.   Je vous la recommande si vous cherchez quelqu'un de sérieux et engagé dans vos projets !",
          textPt2: " Experience au top, merci pour ton travail Noémie.",
          author: "NOLEX",
        },
        {
          textPt1:
        ...
        {
          textPt1:
            "J'ai fais appel à Noémie pour plusieurs choses (cartes, flyers, marque page, vidéo) Et je reviendrais sans soucis vers elle. Noemie est à l'écoute, cerne rapidement vos désirs et fait preuve d'un grand professionnalisme.",
        ...
        },
        {
          ...
          textPt2: "Je n'hesiterai pas à retravailler avec elle sur de prochaines missions.",
          author: "CRÉADIS",
        },
        {
