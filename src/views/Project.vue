    ...
    data: function() {
        return {
            projectArray: [
                ...
                {
                    name: 'vynil',
                    tag: ['graphisme', 'illustration','motion'],
                    img: 'vynil.jpg',
                    class: ''
                },
                {
